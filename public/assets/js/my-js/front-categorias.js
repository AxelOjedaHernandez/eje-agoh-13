  ...
  $.ajax({
    ...
    success: function( result ) {
      if(result.estado==1){
        ...
        document.getElementById('observacionesCategoiraActualizar').value=categoria.observaciones;
        //alert(categoria.descripcion);
      }else{
        alert(result.mensaje);
      }
...
function actualizarCategoriaById(){
  ...
  let observacionesCategoria= document.getElementById("observacionesCategoiraActualizar").value;
